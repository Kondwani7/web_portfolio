          ...
          <div className='flex space-x-4 justify-center'>
            <div>
              <Link href="https://github.com/kondwani7">
                <a className="text-3xl text-slate-700 text-center"><DiGithubBadge size={40}/></a>
              </Link>
            </div>
            <div>
              <Link href="https://www.linkedin.com/in/kondwani-ngulube-4489ba174/">
                <a className="text-3xl text-slate-700 text-center"><AiFillLinkedin size={40}/></a>
              </Link> 
            </div>
            <div>
              <Link href="https://twitter.com/Kondwani_G">
                <a className="text-3xl text-slate-700 text-center"><FaTwitter size={40}/></a>
              </Link> 
            </div>
